          ...
          <div ref={cardsContainerRef} className="relative flex-1 perspective-1000">
              ...
              <div className="relative z-10 p-5 sm:p-6 md:p-8 h-full flex items-center">
                <div className="max-w-lg">
                  <h3 className="text-2xl sm:text-3xl md:text-4xl font-display text-white font-bold leading-tight mb-4">
                    We're building the intelligent infrastructure for Web3's future
                  </h3>
                </div>
              </div>
            </div>
            ...
            >
              ...
              <div className="relative z-10 p-5 sm:p-6 md:p-8 h-full flex items-center">
                <div className="max-w-lg">
                  <h3 className="text-2xl sm:text-3xl md:text-4xl font-display text-white font-bold leading-tight mb-4">
                    We're creating AI systems that understand decentralized networks
                  </h3>
                </div>
              </div>
            </div>
            ...
            >
              ...
              <div className="relative z-10 p-5 sm:p-6 md:p-8 h-full flex items-center">
                <div className="max-w-lg">
                  <h3 className="text-2xl sm:text-3xl md:text-4xl font-display text-white font-bold leading-tight mb-4">
                    We're pioneering <span className="text-[#FC4D0A]">research</span> that defines tomorrow's technology
                  </h3>
                </div>
              </div>
            </div>
